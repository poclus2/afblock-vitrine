        ...
        <header className="relative overflow-hidden pt-20 pb-32 gradient-mesh">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
                    <a href="https://afblock-business.dartsia.app/signup" className="bg-primary hover:bg-blue-900 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-xl shadow-primary/20 transition-all transform hover:-translate-y-1 flex items-center justify-center text-center">
                        Open account
                    </a>
                    <Link to="/demo" className="bg-transparent border-2 border-primary dark:border-white/20 text-primary dark:text-white hover:bg-primary/5 dark:hover:bg-white/10 px-8 py-4 rounded-full text-lg font-semibold transition-all flex items-center justify-center text-center">
                        Book a demo
                    </Link>
                </div>
