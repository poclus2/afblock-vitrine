                        ...
                        >
                            ...
                            <div className="p-6 flex-1 flex flex-col">
                                ...
                                <div className="mt-auto pt-4 border-t border-gray-100 dark:border-gray-700 flex items-center justify-between">
                                    <Link to={`/blog/${post.id}`} className="text-sm font-medium text-primary dark:text-white group-hover:underline decoration-accent underline-offset-4 decoration-2">
                                        Read more
                                    </Link>
